...
const REACTIONS = [
  {
    label: "Worried",
    src: require("../../../assets/Images/Feedback/worried.png"),
    bigSrc: require("../../../assets/Images/Feedback/worried_big.png"),
  },
  {
    label: "Sad",
    src: require("../../../assets/Images/Feedback/sad.png"),
    bigSrc: require("../../../assets/Images/Feedback/sad_big.png"),
  },
  {
    label: "Strong",
    src: require("../../../assets/Images/Feedback/ambitious.png"),
    bigSrc: require("../../../assets/Images/Feedback/ambitious_big.png"),
  },
  {
    label: "Happy",
    src: require("../../../assets/Images/Feedback/smile.png"),
    bigSrc: require("../../../assets/Images/Feedback/smile_big.png"),
  },
  {
    label: "Surprised",
    src: require("../../../assets/Images/Feedback/surprised.png"),
    bigSrc: require("../../../assets/Images/Feedback/surprised_big.png"),
  },
];
const WIDTH = 320;
    ...
    return (
      <View style={styles.container}>
        <View style={styles.wrap}>
          <Text style={styles.welcome}>How do you feel?</Text>
          ...
          <View style={styles.reactions}>
            {REACTIONS.map((reaction, idx) => {
              ...
              if (u - 20 < 0) {
                ...
                topOutputRange = [10, 0];
                colorOutputRange = [COLORS.primary, COLORS.lightgrey];
              }
              ...
              if (u + 20 > END) {
                ...
                topOutputRange = [0, 10];
                colorOutputRange = [COLORS.lightgrey, COLORS.primary];
              }
